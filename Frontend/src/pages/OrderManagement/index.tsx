      ...
      <div className="max-w-7xl mx-auto bg-white rounded-2xl  p-6 lg:p-10">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button className="flex items-center bg-blue-500 hover:bg-blue-800 text-white font-semibold py-2.5 px-6 rounded-xl transition-colors duration-200 shadow-md">
