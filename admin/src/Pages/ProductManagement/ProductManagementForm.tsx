      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between pb-4 border-b border-gray-200">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button className="px-4 py-2 text-white bg-blue-600 hover:bg-blue-700 rounded-lg font-medium transition-colors">
              Publish
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="col-span-1 md:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 space-y-4">
              ...
              <div className="flex space-x-1 p-1 bg-gray-100 rounded-lg">
                <button className="flex-1 px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg">General</button>
          ...
          <div className="col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 space-y-4">
              ...
              <div className="flex items-center justify-between mt-4">
                ...
                <button
                  ...
                  className={`relative inline-flex items-center h-6 rounded-full w-11 transition-colors ${visibility ? 'bg-blue-600' : 'bg-gray-200'}`}
                >
                  <span
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 space-y-4">
              ...
              <button className="w-full py-2 bg-blue-100 text-blue-600 font-medium rounded-lg hover:bg-blue-200 transition-colors">
                Preview
              </button>
            </div>
          </div>
