...
const Sidebar = () => (
  ...
  <aside className="w-64 bg-white  rounded-lg shadow-md font-inter p-1 ">
    <div className='p-5'>
    <h3 className="text-lg font-bold mb-4">Categories</h3>
    <ul className="space-y-2 text-sm text-gray-700">
      {['Fruits & Vegetables', 'Meats & Seafood', 'Breakfast & Dairy', 'Organic Products', 'Frozen Foods', 'Sweets & Bakery', 'Snacks & Brands', 'Grocery & Staples'].map(item => (
        <li key={item} className="flex items-center justify-between p-2 rounded-md hover:bg-gray-100 transition-colors cursor-pointer">
          <span>{item}</span>
     ...
     <div className='relative  rounded-md overflow-hidden  bg-blue-400  mb-1'>
